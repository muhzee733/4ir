    ...
    <footer className="footer-main border-top footer-background rounded py-4">
      <div className="container mt-3 mb-3">
        <div className="row">
          <div className="col-lg-6 col-md-">
            <div className="row">
              ...
              <div className="col-lg-12 fs-5 my-3 footer-subtitle">SUBSCRIBE TO OUR NEWSLETTER</div>
          ...
          <div className="col-lg-6">
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6">
                <div className="footer-title skyblue fs-4 my-3" onClick={() => setQuickLinksOpen(!isQuickLinksOpen)}>
              ...
              <div className="col-lg-6 col-md-12 my-3">
                <div className="footer-title skyblue fs-4 d-flex" onClick={() => setServicesOpen(!isServicesOpen)}>
                  <Image src={Star} className="img-fluid me-3" alt="star" priority />
        ...
        <div className="row border-top border-secondary">
          <div className="col-lg-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-start copyright">
            <div>© 2024 4IR All the Copyright Reserved.</div>
          </div>
          <div className="col-lg-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-end copyright">
