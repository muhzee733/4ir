                    ...
                    <div className='container-fluid'>
                        ...
                        <img src='/images/4IR-logo-main.png' width='200px' />
                            ...
                            <div className='col-lg-6 col-md-12 d-flex justify-content-center align-items-center'>
                                <figure >
                                    <img className='bannerImg1' src='/images/man-in-frame.png' alt='lead generation image' />
                                </figure>
                            </div>
                        </div>
                    </div>
          ...
          <div className="container">
            <div className="second-sec-content">
              ...
              <div className="second-sec-des d-flex justify-content-center flex-column  align-items-center">
                <H6 title="Are these common sales challenges holding your business back?" className="text-white fs-2 mt-4" />
                <button className="btn-1 fs-2 mt-4 px-5 ">It’s time to make a change</button>
              </div>
            </div>
          </div>
        </div>
